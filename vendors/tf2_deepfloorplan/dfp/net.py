    ...
    def __init__(self, config: argparse.Namespace = None):
        ...
        self.hf = [
            tf.keras.layers.Conv2D(
                ...
                trainable=False,
                use_bias=False,
                kernel_initializer=tf.constant_initializer(self.hs[i]),
            )
        ...
        self.vf = [
            tf.keras.layers.Conv2D(
                ...
                trainable=False,
                use_bias=False,
                kernel_initializer=tf.constant_initializer(self.vs[i]),
            )
            for i in range(len(dak))
        ]
        # diagonal
        ...
        self.df = [
            tf.keras.layers.Conv2D(
                ...
                trainable=False,
                use_bias=False,
                kernel_initializer=tf.constant_initializer(self.ds[i]),
            )
            for i in range(len(dak))
        ]
        # diagonal flip
        ...
        self.dff = [
            tf.keras.layers.Conv2D(
                ...
                trainable=False,
                use_bias=False,
                kernel_initializer=tf.constant_initializer(self.dfs[i]),
            )
            for i in range(len(dak))
        ]
        # expand dim
